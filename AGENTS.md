...
## 硬约束（不可违反）
- 单文件、完全离线、无 CDN、目标 ≤3MB（当前约 697KB，含内嵌真实古琴音频）
...
已完成：
- 122 首诗（小学70 + 初中52，含课外诵读；小学1-6+初中7-9 课内古诗已基本覆盖，含《木兰诗》《关雎》《蒹葭》《水调歌头》《过零丁洋》等；年级 1-9 全覆盖）；五大入口（年级/卡片墙/知识图谱/地图/时间轴）+ 闯关；三角色（学生/家长/教师）可切换；探索/学习模式
